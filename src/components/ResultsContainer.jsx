...
export default function ResultsContainer({ data, activePF }) {
      ...
      <div className="results" style={{ display: "block" }}>
        <div className="empty-state">
          ...
          <div className="empty-state-sub">
            We couldn't find any products on your selected platforms. Try
            adjusting your platform filters or search for a different product.
          </div>
        </div>
      </div>
    );
  ...
  const savingsPercent =
    maxP > 0 ? Math.round(((maxP - minP) / maxP) * 100) : 0;
        ...
        <div>
          ...
          <div className="prod-badges">
            ...
            <span className="pbadge">
              ⭐ {totRev.toLocaleString("en-IN")} ratings
            </span>
          ...
          <div className="prod-stats">
            ...
            >
              ...
              <div className="pstat-v" style={{ color: "var(--green)" }}>
            ...
            >
              ...
              <div className="pstat-v" style={{ color: "var(--red)" }}>
            ...
            >
              ...
              <div className="pstat-v" style={{ color: "var(--green)" }}>
                ₹{(maxP - minP).toLocaleString("en-IN")}
              </div>
            </div>
            <div
              className="pstat"
            ...
            >
              ...
              <div className="pstat-v" style={{ color: "var(--primary)" }}>
                ₹{avgP.toLocaleString("en-IN")}
              </div>
            </div>
          </div>
        </div>
