  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        throw new Error(
          `Server returned non-JSON response (Setup issue or Backend down): ${text.substring(0, 30)}...`,
        );
      }
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.target.style.background = "var(--red-s)";
            e.target.style.color = "var(--red)";
            e.target.style.borderColor = "var(--red-b)";
          }}
          onMouseLeave={(e) => {
        ...
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          ...
          <p style={{ fontSize: "14px", color: "var(--ink3)", margin: 0 }}>
            {isLogin
              ? "Sign in to access your price alerts"
              : "Join SmartCart to track prices"}
          </p>
        </div>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.target.style.boxShadow = "var(--sh)";
          }}
          onMouseLeave={(e) => {
            e.target.style.background = "var(--off)";
            e.target.style.borderColor = "var(--line)";
