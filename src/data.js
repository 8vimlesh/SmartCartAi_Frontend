...
export const DEMO = {
  "Sony WH-1000XM5": {
    ...
    cat: "Audio",
    mrp: 34990,
    desc: "Industry-leading noise cancellation · 30h battery",
    img: "https://m.media-amazon.com/images/I/61vMBKxQnXL._SX679_.jpg",
    pf: {
      amazon: {
        p: 24999,
        r: 4.6,
  ...
  "Nike Air Force 1": {
    ...
    cat: "Footwear",
    mrp: 8495,
    desc: "Classic low-top leather sneaker",
  ...
  "Apple iPhone 15": {
    ...
    cat: "Smartphones",
    mrp: 79900,
    desc: "6.1″ Super Retina XDR · A16 Bionic",
  ...
  "boAt Airdopes 141": {
    ...
    cat: "Audio",
    mrp: 3490,
    desc: "42H playback · ENx Tech · ASAP Charge",
    img: "https://m.media-amazon.com/images/I/61CXMGPPBWL._SX679_.jpg",
    pf: {
      amazon: {
        p: 999,
        r: 4.1,
  ...
  "Samsung Galaxy S24": {
    ...
    cat: "Smartphones",
    mrp: 74999,
    desc: "Galaxy AI · 50MP · Snapdragon 8 Gen 3",
    img: "https://m.media-amazon.com/images/I/71bBnBJjAXL._SX679_.jpg",
    pf: {
      amazon: {
        p: 61999,
        r: 4.5,
...
export function genH(days, bases) {
  ...
  for (const [k, bp] of Object.entries(bases)) {
    h[k] = [];
    let p = Math.round(bp * 1.1);
    for (let i = days - 1; i >= 0; i--) {
      const d = new Date(now);
      d.setDate(d.getDate() - i);
      const noise = Math.round((Math.random() - 0.52) * bp * 0.025);
      p = Math.max(
        Math.round(bp * 0.92),
        Math.min(Math.round(bp * 1.12), p + noise),
      );
      if (i === 0) p = bp;
